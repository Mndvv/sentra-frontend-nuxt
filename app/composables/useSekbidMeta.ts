...
const _komisiMeta: Record<string, SekbidMeta> = {
  A: { icon: 'material-symbols:diversity-1-rounded',     color: '#0ea5e9', glow: 'rgba( 14, 165, 233, 0.14)', short: 'Komisi A' },
  B: { icon: 'material-symbols:sports-handball-rounded',  color: '#f59e0b', glow: 'rgba(245, 158,  11, 0.14)', short: 'Komisi B' },
  C: { icon: 'material-symbols:partner-exchange-rounded',color: '#10b981', glow: 'rgba( 16, 185, 129, 0.14)', short: 'Komisi C' },
  D: { icon: 'material-symbols:travel-explore-rounded',    color: '#8b5cf6', glow: 'rgba(139,  92, 246, 0.14)', short: 'Komisi D' },
  E: { icon: 'material-symbols:person-check-rounded',    color: '#ec4899', glow: 'rgba(236,  72, 153, 0.14)', short: 'Komisi E' },
}
